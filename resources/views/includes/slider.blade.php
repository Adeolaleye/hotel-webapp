                ...
                <div id="fullscreen_slider" class="rev_slider fullscreenbanner gradient_slider" style="display:none" data-version="5.4.1">
                    <ul>
                        ...
                        <li data-transition="fade">
                            <!-- MAIN IMAGE -->
                            <img src="{{asset('images/slider/slide1.jpg')}}"
                                 alt="Image"
                                 title="slider_bg1-1"
                            ...
                            <div class="tp-caption tp-resizeme"
                                 ...
                                 data-frames='[{"delay":800,"speed":1000,"frame":"0","from":"y:[100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;opacity:0;","mask":"x:0px;y:[100%];s:inherit;e:inherit;","to":"o:1;","ease":"Power2.easeInOut"},{"delay":"wait","speed":500,"frame":"999","to":"auto:auto;","ease":"Power3.easeInOut"}]'
                                 style="z-index: 5; color: #fff; font-weight: 900; font-family: cursive;">TAKE A VIRTUAL TOUR OF OUR VILLA
                            </div>
                            <!-- LAYER NR. 2 -->
                            <div class="tp-caption tp-resizeme"
                                 data-x="center"
                                 ...
                                 data-transform_out="y:[100%];s:1000;e:Power2.easeInOut;s:100InOut;"
                                 ...
                                 style="z-index: 9; font-weight: 400; color: rgba(255, 255, 255, 0.8); font-family:cursive;font-size: 38px;" > Feel safe and Enjoy your stay at Mcarthurs Nest
                            </div>
                        </li>
                        ...
                        <li data-transition="fade"
                            ...
                            <!-- MAIN IMAGE -->
                            <img src="{{asset('images/slider/slide9.jpg')}}"
                                 alt="Image"
                                 title="slider_bg1-2"
                                 data-bgposition="center center"
                                 data-bgfit="cover"
                            ...
                            <div class="tp-caption tp-resizeme"
                                 ...
                                 style="z-index: 5; color: #fff; font-weight: 900;font-family: cursive;">RELAX AND ENJOY YOUR VACATION
                            </div>
                            <!-- LAYER NR. 2 -->
                            <div class="tp-caption tp-resizeme"
                                 data-x="center"
                                 ...
                                 data-responsive="off"
                                 data-elementdelay="0.05"
                                 style="z-index: 9; font-weight: 400; color: rgba(255, 255, 255, 0.8); font-family: Raleway;font-family: segoui;">
                            </div>
                        </li>
                        ...
                        <li data-transition="fade"
                            ...
                            data-masterspeed="1000">
                            <!-- MAIN IMAGE -->
                            <img src="{{asset('images/slider/slide3.jpg')}}"
                                 alt="Image"
                                 title="slider_bg1-3"
                                 data-bgposition="center center"
                                 data-bgfit="cover"
                            ...
                            <div class="tp-caption tp-resizeme"
                                 ...
                                 data-responsive="off"
                                 data-elementdelay="0.05"
                                 style="z-index: 9; font-weight: 400; color: rgba(255, 255, 255, 0.8); font-family: Raleway;">
                           </div>
                        </li>
                    ...
                    @include('includes.alerts')
                        <form id="booking-form" method="post" action="{{ route('createbooking') }}">
                            ...
                            <div class="col-md-2 md_pl5">
                                <button type="submit" class="button  btn_blue btn_full" style="background-color: rgb(2, 49, 2);;">BOOK A ROOM</button>
                            </div>
                        </form>
                    </div>
                </div>
